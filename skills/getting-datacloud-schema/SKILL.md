...
description: Retrieve Data Lake Object (DLO) and Data Model Object (DMO) schema information
  from Salesforce Data Cloud using REST APIs. Use this skill when you need to inspect DLO
  or DMO field definitions, data types, or metadata. Takes org alias and optional DLO/DMO
  name as parameters.
metadata:
  version: '1.0'
...
> MCP servers live in `.vscode/mcp.json`. Invoke this skill with `/getting-datacloud-schema` if it does not auto-load.
